...
export default function Example(props) {
    ...
    return (
        ...
        >
          ...
          group inline-flex items-center rounded-md px-2 py-1 text-base font-medium text-white hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75
          ${color? 'bg-black':'bg-orange-700'}`}
            >
                <span>{name}</span>
                <span
        ...
        ><ChevronUpIcon /> 
          {/* {popoverOpen ? <ChevronUpIcon /> : <ChevronDownIcon />} */}
            ...
            transition-transform ease-in-out duration-200`}
                >
                    <div className="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 pt-3" onMouseEnter={() => setPopoverOpen(true)}
                        onMouseLeave={() => setPopoverOpen(false)}>
...
// IconOne, IconTwo, and IconThree functions remain unchanged
