  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex justify-center items-center w-full h-24 ">
          ...
          <div>
            <div className="flex">
              <img src="https://static1.hkrtcdn.com/hknext/static/media/checkout/fill-blue.svg" />
          ...
          <div>
            <div className="flex">
              <img src="https://static1.hkrtcdn.com/hknext/static/media/checkout/blue-address.svg" />
              <div className="bg-gray-200 mt-5 w-44 h-1">
                <div
                  className="bg-gray-300 h-1"
                  style={{ width: "100%" }}
