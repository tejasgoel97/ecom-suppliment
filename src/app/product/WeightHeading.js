    ...
    return (
        <>
            <div className='mt-12 flex gap-8'>
                ...
                <div className='mr-3 font-bold text-3xl'>Weight</div>
                <div className="inline-flex border border-green-200">
                    <button className=" bg-green-200 text-gray-800  py-2 px-4">KG</button>
                    <button className=" text-gray-800  py-2 px-4 ">LB</button>
                </div>
            </div>
